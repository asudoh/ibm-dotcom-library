...
export { default } from './masthead.stories';

const StoryContent = () => (
  <>
    <style type="text/css">{contentStyles.cssText}</style>
    <main className="bx--content dds-ce-demo-devenv--ui-shell-content">
...
export const Default = ({ parameters }) => {
  ...
  return (
    <>
      ...
      <DDSMastheadContainer brandName={brandName} navLinks={navLinks} userStatus={userStatus} />
      {StoryContent()}
    </>
  );
};
