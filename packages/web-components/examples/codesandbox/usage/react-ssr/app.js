...
const { mapDispatchToProps } = require('@carbon/ibmdotcom-web-components/lib/components/masthead/masthead-connect.js');
const { store } = require('@carbon/ibmdotcom-web-components/lib/components-react-node/masthead/masthead-container.js');
